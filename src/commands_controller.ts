...
export class CommandsController implements Disposable {
    ...
    public constructor(private main: MainController) {
        ...
        this.disposables.push(
            commands.registerCommand("vscode-neovim.ctrl-f", () =>
                this.scrollPage("page", "down"),
            ),
            commands.registerCommand("vscode-neovim.ctrl-b", () =>
                this.scrollPage("page", "up"),
            ),
            commands.registerCommand("vscode-neovim.ctrl-d", () =>
                this.scrollPage("halfPage", "down"),
            ),
            commands.registerCommand("vscode-neovim.ctrl-u", () =>
                this.scrollPage("halfPage", "up"),
            ),
            commands.registerCommand("vscode-neovim.ctrl-e", () =>
                this.scrollLine("down"),
            ),
            commands.registerCommand("vscode-neovim.ctrl-y", () =>
                this.scrollLine("up"),
            ),
            eventBus.on("reveal", ([at, updateCursor]) =>
    ...
    private scrollLine = (to: "up" | "down"): void => {
        vscode.commands.executeCommand("editorScroll", {
            to,
            by: "line",
            revealCursor: config.revealCursorScrollLine,
        });
    };
